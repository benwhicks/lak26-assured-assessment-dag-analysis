...
What are the common triads? Do these agree?
...
p_time_and_representaion
ggsave("figures/FIG--time-modelling-and-representation.png", width = 6, height = 3, dpi = 600)
```
...
ggsave("figures/FIG--consensus-sub-model-filtered.png", p_top_node_groups_filtered, dpi = 600, height = 4, width = 6)
```
...
ggsave("figures/FIG--consensus-sub-model-full.png", p_top_node_groups_full, dpi = 600, height = 4, width = 6)
```
...
ggsave("figures/FIG--node_pagerank_no_outcome.png", p_top_node_pagerank_no_outcome, width = 10, height = 4, dpi = 600)
```
